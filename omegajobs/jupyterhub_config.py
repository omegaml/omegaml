...
c.JupyterHub.authenticator_class = 'omegajobs.hubauth.OmegaAuthenticator'
...
#  Default: '/home/omegadev/miniforge3/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/omegadev/miniforge3/share/jupyterhub'
...
c.JupyterHub.db_url = os.environ.get('JUPYTERHUB_DB_URL') or 'sqlite:///jupyterhub.sqlite'
...
# -- https://jupyterhub.readthedocs.io/en/stable/rbac/roles.html#overriding-default-roles
# restrict the token issued to admin user servers to only have access to their own resources
c.JupyterHub.load_roles = [
    {
        'name': 'server',
        'scopes': ['inherit'],
...
spawner_cmd = SPAWNER_CMD.get(spawner_type)
...
c.Spawner.env_keep = ['PATH', 'PYTHONPATH', 'CONDA_ROOT', 'JY_DEFAULT_URL', 'JUPYTERHUB_SINGLEUSER_APP',
                      'CONDA_DEFAULT_ENV', 'VIRTUAL_ENV', 'LANG', 'LC_ALL',
                      'OMEGA_ROOT', 'OMEGA_FRAMEWORKS']
...
c.Authenticator.admin_users = {jyuser}
