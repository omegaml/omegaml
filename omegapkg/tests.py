...
from omegacommon.util import mkdirs
from omegaml import Omega
from omegaml.util import settings, delete_database
from omegapkg import PythonPackageData
from omegapkg import build_sdist
...
class PythonPackageDataTests(TestCase):
    ...
    def setUp(self):
        ...
        self.backend = backend = 'omegapkg.PythonPackageData'
        self.mixin = mixin = 'omegapkg.PythonPackageMixin'
        ...
        self.distdir = os.path.join(os.path.dirname(__file__), 'demo', 'helloworld', 'dist')
    ...
    def test_runtime(self):
        ...
        self.assertEqual(data['result'], ('hello from helloworld', {'text': 'foo'}))
