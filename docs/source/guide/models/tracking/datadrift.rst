...
To compare different snapshots, we can specify the specific sequence numbers to compare, either the absolute
...
.. code::
    ...
    stats = mon.compare(seq='baseline')
