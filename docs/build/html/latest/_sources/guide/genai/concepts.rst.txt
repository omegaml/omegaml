...
responses across a longer conversation.
...
OCI Repository Model Deployments
------------------------------

.. versionadded:: 0.18.0

AI models tend to be several GB in size, requiring specialized storage. OCI repositories, also
known as container/docker image repositories, are a perfect match. They have been built to
support arbitrary storage sizes efficiently and serve as a backbone for deployment to clusters.

omega-ml's model store provides transparent support for storing any model into a OCI repository.
...
distribution and runtime loading using a registered OCI repository.
