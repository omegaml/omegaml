...
def signature(filter):
    ...
    # -- the signature is a hash of the values and the current thread id
    # -- thus a remote attacker cannot easily forge (pass-in) the signature as part of a query
    # -- note that filters are often passed as kwargs, thus an adversary could pass
    #    a signature as part of the kwargs, thus the signature is also based on the thread id
    #    which the adversary cannot control or know without having full access to the systems
