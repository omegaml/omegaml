...
class PromotionMixin(object):
    ...
    * virtualobj.dill - uses the `export` promotion, effectively copying all
    ...
    def promote(self, name, other, asname=None, drop=None, method='default', get=None, put=None, **kwargs):
        ...
        if hasattr(backend, 'promote'):
            return backend.promote(name, other, asname=asname, drop=drop, get=get, put=put, method=method, **kwargs)
        ...
        promotion_methods = self.promotion_methods(
            name, other, asname=asname, drop=drop, get=get, put=put, backend=backend, **kwargs
        )
    ...
    def promotion_methods(self, name, other, asname=None, drop=None, get=None, put=None, backend=None, **kwargs):
        ...
        PROMOTION_METHODS = {
            ...
            'export': partial(self._export_promotion, name, other, asname=None, drop=False, get=get, put=put, **kwargs),
        }
    ...
    def _metadata_promotion(self, name, other, asname=None, drop=False, **kwargs):
        ...
        asname = asname or meta.name
        other.drop(asname, force=True) if drop else None
        other_meta = other.make_metadata(asname, meta.kind, bucket=other.bucket, prefix=other.prefix, **kwargs)
