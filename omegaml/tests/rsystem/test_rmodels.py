...
@unittest.skipUnless(
    r_available and not inside_r,
    "results consolidated as RSystemTestCase.test_inside_r result",
)
...
@unittest.skipUnless(
    inside_r, "results consolidated as RSystemTestCase.test_inside_r result"
)
