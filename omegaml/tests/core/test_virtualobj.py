...
from omegaml.backends.virtualobj import (
    VirtualObjectBackend,
    virtualobj,
...
class VirtualObjectTests(OmegaTestMixin, TestCase):
    ...
    def test_virtualobj_promotion(self):
        ...
        self.assertNotEqual(
            meta.attributes.get("versions"), other_meta.attributes.get("versions")
        )
...
@virtualobj
def myvirtualobjfn_with_basename(
    data=None, meta=None, method=None, base_name=None, store=None, **kwargs
):
    import datetime
