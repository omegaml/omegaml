...
locations = [
    {'location': {'coordinates': [-74.0059413, 40.7127837], 'type': 'Point'}, 'place': 'New York'},
    {'location': {'coordinates': [6.1431577, 46.2043907], 'type': 'Point'}, 'place': 'Geneva'},
    {'location': {'coordinates': [7.4474468, 46.9479739], 'type': 'Point'}, 'place': 'Bern'},
    {'location': {'coordinates': [8.541694, 47.3768866], 'type': 'Point'}, 'place': 'Zurich'},
]
...
class FilterQueryTests(TestCase):
    ...
    def test_filter_near(self):
        ...
        # closest place
        result = Filter(coll, location__near=dict(location=(8.541694, 47.3768866), maxd=1))
