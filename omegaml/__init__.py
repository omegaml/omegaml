...
#: session cache
session_cache = cachetools.cached(
    cache=cachetools.TTLCache(**_base_config.OMEGA_SESSION_CACHE)
)
...
version = getattr(_omega, "version", version)
Omega = _omega.Omega
_omega.OmegaDeferredInstance = getattr(
    _omega, "OmegaDeferredInstance", OmegaDeferredInstance
)
# setup API
