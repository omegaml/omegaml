...
class AlertRule:
    def __init__(
        self, monitor=None, event=None, action=None, recipients=None, since=None
    ):
        ...
        self.since = since or datetime.utcnow() - timedelta(
            seconds=defaults.OMEGA_MONITORING_DRIFT_INTERVAL
        )
    ...
    def notify(self, recipients, data):
        ...
        self.monitor.tracking.log_event(
            "alert", self.monitor._drift_alert_key, data, recipients=recipients
        )
