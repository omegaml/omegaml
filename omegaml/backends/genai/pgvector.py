...
from omegaml.backends.genai.index import VectorStore
...
class PGVectorBackend(VectorStore):
    ...
    def find_similar(self, name, obj, top=1, filter=None, distance=None, **kwargs):
        ...
        with Session as session:
            ...
            data = [dict(row) for row in results.all()]
        return data
    ...
    def _create_collection(self, name, collection, vector_size, **kwargs):
        ...
        docs_table = collection or self._default_collection(name)
