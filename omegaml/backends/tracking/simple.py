...
class OmegaSimpleTracker(TrackingProvider):
    ...
    def log_event(self, event, key, value, step=None, dt=None, **extra):
        ...
        Args:
            ...
            key (str): the key to use, defaults to 'event'
        ...
        Notes:
            * events generated by tracking include 'start', 'stop', 'param', 'metric',
              'data', 'system'
            * events generated by the runtime include 'task_call', 'task_failure', 'task_retry',
              'task_success'
            * events generated by drift monitoring include 'snapshot', 'drift', 'monitor', 'drift'
            * events generated by the model backends include 'fit', 'predict', 'complete', 'embed'
            * to ensure your own events are distinct from the above or future system events, prefix
              your events with 'user_' or an application code (e.g. 'myapp_')

        .. versionchanged:: 0.17.0
           added documentation on events throughout the system
        """
